    ...
    <div class="float-left mx-2.5 w-auto py-8 pr-2 sm:w-auto">
        <nav>
            <div class="section-title text-lg">AUTOMATION
                <ul>
                    <li><a href="#" class="inline-flex items-center p-2 text-sm font-medium text-center text-blue-400 hover:bg-blue-800 sm:w-auto rounded-sm">Call flows</a></li>
                    <li><a href="#" class="inline-flex items-center p-2 text-sm font-medium text-center text-blue-400 hover:bg-blue-800 sm:w-auto rounded-sm">Message flows</a></li>
                    <li><a href="#" class="inline-flex items-center p-2 text-sm font-medium text-center text-blue-400 hover:bg-blue-800 sm:w-auto rounded-sm">Keypad Scoring</a></li>                    
                </ul>
            </div>
